...
if platform.system() == "Linux":
    subprocess.run("./gradlew assemblePlayStoreRelease bundlePlayStoreRelease --stacktrace", shell=True, check=True)
else:
    subprocess.run("gradlew assemblePlayStoreRelease bundlePlayStoreRelease --stacktrace", shell=True, check=True)

if platform.system() == "Linux":
    subprocess.run("./gradlew assembleGalaxyStoreRelease bundleGalaxyStoreRelease --stacktrace", shell=True, check=True)

else:
    subprocess.run("gradlew assembleGalaxyStoreRelease bundleGalaxyStoreRelease --stacktrace", shell=True, check=True)

if platform.system() == "Linux":
    subprocess.run("./gradlew assembleUniversalRelease bundleUniversalRelease --stacktrace", shell=True, check=True)
else:
    subprocess.run("gradlew assembleUniversalRelease bundleUniversalRelease --stacktrace", shell=True, check=True)

if platform.system() == "Linux":
    subprocess.run("./gradlew assembleInternalRelease bundleInternalRelease --stacktrace", shell=True, check=True)
else:
    subprocess.run("gradlew assembleInternalRelease bundleInternalRelease --stacktrace", shell=True, check=True)
